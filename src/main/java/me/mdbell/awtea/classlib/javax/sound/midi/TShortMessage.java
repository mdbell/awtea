...
public class TShortMessage extends TMidiMessage {
     ...
     * @since 1.7
     */
    public TShortMessage(int status) throws InvalidMidiDataException {
        super(null);
     ...
     * @since 1.7
     */
    public TShortMessage(int status, int data1, int data2)
     ...
     * @since 1.7
     */
    public TShortMessage(int command, int channel, int data1, int data2)
            throws InvalidMidiDataException {
        super(null);
    ...
    protected TShortMessage(byte[] data) {
    ...
    public Object clone() {
        ...
        return new TShortMessage(newData);
    }
