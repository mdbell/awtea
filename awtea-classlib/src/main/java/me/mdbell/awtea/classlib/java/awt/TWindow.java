 ...
 * <p>
 * In awtea, TWindow serves as the base class for all top-level heavyweight
 * windows
 * (TFrame, and future TDialog implementations).
 * <p>
 * This class is abstract because it requires subclasses to provide the surface
 * graphics
...
public abstract class TWindow extends TSurface {
     ...
     * either of dimensions
     * is less than the minimum size as specified by previous call to
     * {@code setMinimumSize}.
     * <p>
     * If the window and/or its owner are not displayable yet, both of them are made
     * displayable
     * before calculating the preferred size. The Window is validated after its size
     * is being calculated.
     * <p>
     * This implementation properly uses the layout manager to compute the preferred
     * size,
    ...
    /**
     * If this Window is visible, brings this Window to the front and may make it
     * the focused Window.
     * <p>
     ...
     * <p>
     * Subsequent calls to {@code pack()} will ensure the window is at least this
     * size.
     ...
     * border.
     * <p>
     * The default implementation returns zero insets. Subclasses like TFrame may
     * override
