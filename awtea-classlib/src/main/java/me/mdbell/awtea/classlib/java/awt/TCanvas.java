 ...
 *
 * <p>
 * A lightweight canvas component designed for custom drawing within AWT
 * containers.
 * This component does not manage its own DOM element or rendering surface;
 * instead,
 * it renders into its parent container's surface as part of the normal AWT
 * paint
 * event flow.
 * </p>
 *
 ...
 * <li>Components that need AWT layout management (GridLayout, BorderLayout,
 * etc.)</li>
 * <li>Scenarios where you want minimal resource overhead</li>
 * <li>When you need standard AWT component behavior (focus, events, bounds,
 * etc.)</li>
 * </ul>
 *
 * <p>
 ...
 * TCanvas canvas = new TCanvas() { @Override
 ...
 * 
 * <pre>{@code
 * canvas.addMouseListener(new TMouseAdapter() { @Override
 ...
 *
 * <p>
 * <b>Comparison with THeavyCanvas:</b>
 * </p>
 * <table border="1">
 * <tr>
 * <th>Feature</th>
 ...
 *
 * <p>
 * For top-level windows, high-performance rendering, or direct hardware
 * acceleration
 * needs, consider using {@link THeavyCanvas} instead.
 * </p>
 *
 * @see THeavyCanvas The heavyweight canvas component with its own DOM element
 *      and surface
