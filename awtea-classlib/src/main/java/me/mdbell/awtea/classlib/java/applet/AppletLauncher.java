...
/**
 * Launcher for awtea applets that provides ES2015 module exports for JavaScript
 * integration.
 * 
 * <p>
 * This class enables two ways to launch applets:
 * <ul>
 * <li><strong>Automatic discovery:</strong> Call {@link #main(String[])} (or
 * use the ES module's
 * default export) to automatically find and launch applets on canvases with the
 * {@code data-awtea-applet} attribute.</li>
 * <li><strong>Manual launch:</strong> Call {@link #launchNamed(String, String)}
 * from JavaScript
 * to launch a specific applet on a specific canvas.</li>
 * </ul>
 * 
 * <p>
 * <strong>Automatic Discovery Example:</strong>
 * 
 * <pre>
 * HTML:
 ...
 * 
 * <p>
 * <strong>Manual Launch Example:</strong>
 * 
 * <pre>
 * JavaScript (ES2015 module):
...
public final class AppletLauncher {
     ...
     * Scans the DOM for canvas elements with the {@code data-awtea-applet}
     * attribute
     * and launches the corresponding registered applets.
     * 
     * <p>
     * When running on the JVM (not TeaVM), creates a Frame for each registered
     * applet
     ...
     */
    @org.teavm.jso.JSBody(params = { "oldCanvas", "newCanvas",
            "canvasId" }, script = "var parent = oldCanvas.parentNode;" +
                    "if (parent) {" +
