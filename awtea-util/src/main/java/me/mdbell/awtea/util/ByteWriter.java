...
public class ByteWriter {
     ...
     * Note: JavaScript doesn't have true 64-bit integers, so this uses two 32-bit
     * writes.
     */
    ...
    public int getRemainingBytes() {
        return (basePtr + maxBytes) - position;
    }
    ...
    public boolean hasSpace(int bytes) {
        return position + bytes <= basePtr + maxBytes;
    }
    ...
    public double getUtilization() {
        return (double) (position - basePtr) / maxBytes;
    }
