rootProject.name = "awtea"

include("awtea-core")
include("awtea-classlib")
include("awtea-instrument")
include("awtea-graphics")
include("awtea-sound")
include("awtea-input")
include("awtea-net")
include("awtea-ui")
...
include("awtea-sound:worklet")
findProject(":awtea-sound:worklet")?.name = "worklet"
