# Class: `Path2D` ![Coverage](https://img.shields.io/badge/coverage-0.0%25-red)

**Full Name:** `java.awt.geom.Path2D`
...
- `public final java.awt.Shape createTransformedShape(java.awt.geom.AffineTransform)`
