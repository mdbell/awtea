# Class: `HttpURLConnection` ![Coverage](https://img.shields.io/badge/coverage-88.9%25-green)

**Full Name:** `java.net.HttpURLConnection`
...
- `protected java.net.HttpURLConnection(java.net.URL)`
