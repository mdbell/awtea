# Class: `ThreadLocalRandom` ![Coverage](https://img.shields.io/badge/coverage-7.1%25-red)

**Full Name:** `java.util.concurrent.ThreadLocalRandom`
...
- `public float nextFloat(float, float)`
- `public int nextInt()`
