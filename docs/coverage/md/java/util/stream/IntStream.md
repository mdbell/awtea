# Class: `IntStream` ![Coverage](https://img.shields.io/badge/coverage-88.5%25-green)

**Full Name:** `java.util.stream.IntStream`
...
- `public java.util.stream.IntStream mapMulti(java.util.stream.IntStream$IntMapMultiConsumer)`
