# Class: `Collectors` ![Coverage](https://img.shields.io/badge/coverage-86.4%25-green)
...
- `public static java.util.stream.Collector teeing(java.util.stream.Collector, java.util.stream.Collector, java.util.function.BiFunction)`
