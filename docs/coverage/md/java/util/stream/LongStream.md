# Class: `LongStream` ![Coverage](https://img.shields.io/badge/coverage-88.2%25-green)
...
- `public java.util.stream.LongStream mapMulti(java.util.stream.LongStream$LongMapMultiConsumer)`
