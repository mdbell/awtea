# Class: `Stream` ![Coverage](https://img.shields.io/badge/coverage-93.8%25-green)
...
- `public java.util.stream.DoubleStream mapMultiToDouble(java.util.function.BiConsumer)`
- `public java.util.stream.IntStream mapMultiToInt(java.util.function.BiConsumer)`
- `public java.util.stream.LongStream mapMultiToLong(java.util.function.BiConsumer)`
- `public java.util.stream.Stream mapMulti(java.util.function.BiConsumer)`
