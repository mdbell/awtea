# Class: `LongBuffer` ![Coverage](https://img.shields.io/badge/coverage-88.6%25-green)

**Full Name:** `java.nio.LongBuffer`
...
- `public final java.nio.LongBuffer clear()`
- `public final java.nio.LongBuffer flip()`
- `public final java.nio.LongBuffer mark()`
- `public final java.nio.LongBuffer put(long[])`
- `public final java.nio.LongBuffer reset()`
- `public final java.nio.LongBuffer rewind()`
...
- `public final java.nio.LongBuffer limit(int)`
- `public final java.nio.LongBuffer position(int)`
- `public int mismatch(java.nio.LongBuffer)`
