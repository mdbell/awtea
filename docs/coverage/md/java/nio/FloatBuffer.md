# Class: `FloatBuffer` ![Coverage](https://img.shields.io/badge/coverage-88.6%25-green)

**Full Name:** `java.nio.FloatBuffer`
...
- `public final java.nio.FloatBuffer clear()`
- `public final java.nio.FloatBuffer flip()`
- `public final java.nio.FloatBuffer mark()`
- `public final java.nio.FloatBuffer put(float[])`
- `public final java.nio.FloatBuffer reset()`
- `public final java.nio.FloatBuffer rewind()`
...
- `public final java.nio.FloatBuffer limit(int)`
- `public final java.nio.FloatBuffer position(int)`
- `public int mismatch(java.nio.FloatBuffer)`
