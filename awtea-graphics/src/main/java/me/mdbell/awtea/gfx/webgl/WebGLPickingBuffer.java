 ...
 * <p>
 * The picking buffer is an off-screen framebuffer where components render
 * themselves
 ...
 * </p>
 * <p>
 * Unlike traditional rectangular bounds testing, this approach automatically
 * handles:
...
public class WebGLPickingBuffer {
     ...
     * 
     * @param screenFramebuffer the screen framebuffer to render to (or null for
     *                          default)
